...
Figure~\ref{fig:refinement_temporal_throughput} demonstrates that an increase in hit rate
...
This ties in to the third factor: the queries with extreme throughput improvements use a LIMIT clause (interactive-discover-8), thus traversal can be terminated
quickly if an efficient query plan is found and results are produced quickly.
