...
% \todo{Combine as follows: 
% Indexed + Unindexed
% in-memory store + disk-based store.
% Same for random.
% Also reduce space between the figures
% Add fainter lines for the log ticks on x-axis
% Add the algorithm evaluated in top bar 
% (which is coloured in like: \url{https://www.google.com/url?sa=t&source=web&rct=j&url=https%3A%2F%2Fwww.biorxiv.org%2Fcontent%2F10.64898%2F2026.05.25.727627v1.full-text&ved=0CBYQjRxqGAoTCIjOr6Cy0pUDFQAAAAAdAAAAABCFAQ&opi=89978449})
% }
\begin{figure*}[htbp]
    \centering
