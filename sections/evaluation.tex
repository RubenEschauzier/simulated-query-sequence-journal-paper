...
Instead, we validate the data access patterns and temporal locality of the generator using client-side caching as a proxy.
...
reaching up to 100$\times$ speedups compared to the baseline.
