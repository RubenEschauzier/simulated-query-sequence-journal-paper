...
\begin{todolist}
    \item Rework introduction to fit special issue in some way
    \item Add explanation of different approaches we added
    \item Extend same results we have with disk, offline traversal, and quad store
\end{todolist}
