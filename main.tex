...
generating a highly multi-perspective decentralized environment.
\rt{The jump between these sentences feels a bit too large. You could for example add an additional sentence here to talk about why integrating such decentralized data is challenging, and that client-side query engines can solve this.}
...
\verb+Multi-perspective data+ \verb+Link Traversal-based Query Processing+ \verb++ \verb+\end{keyword}+ 
which
