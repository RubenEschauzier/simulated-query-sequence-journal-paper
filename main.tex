...
\title[mode = title]{SolidSessionBench: Realistic Query Sequences for User-Oriented Decentralized Environments}                      
\todo{Should I change the title? I feel like its such a small part of the paper that it doesn't require a mention of multi perspective or it might be deceptive}
